        ...
        <div>
            ...
            <div className="chat-wrapper">
                <div className="chat-box" ref={chatBoxRef}>
                    {messages.map((message, index) => (
                        <Row key={index} className={`${message.isUser ? 'user' : 'chatgpt'}-message-container`}>
                            <Col style={{"max-width": "41px"}}>
                                    {!message.isUser ?
                                        <svg
                                                style={{"background-color": "rgb(11,163,127)", "color": "white", "width": "30px", "height": "30px", "border-radius": "5px", "margin-top": "11px"}}
                                                width="30"
                                                height="30"
                                                viewBox="-8 -8 55 55"
                                                fill="none"
                                        ...
                                        <svg
                                            style={{"background-color": "orange", "color": "white", "width": "30px", "height": "30px", "border-radius": "5px", "margin-top": "11px"}}
                                            width="30"
                                            height="30"
                                            viewBox="-4 -4 40 40">
                            ...
                            <Col className={`${message.isUser ? 'user' : 'chatgpt'}-message`}>
                                {message.text}
                            </Col>
                        </Row>
                    ))}
                ...
                <div className="disclaimer">
                    CHAT ROBOT BY <a href="http://www.rainscales.com/">RAINSCALES</a> (based on ChatGPT (GPT-3.5)).
                </div>
                {isLoading && (
